...
* @return PASS if the player passed or inserted an invalid word more than 3 times, PLAY if the player played or GIVEUP if the player 
		  gave up
*/
 ...
 * 			if the prependicularIndex is passed, the direction of testWord will be the same of played word 
 ...
 */
void updateScores(board_t& board, std::vector<Player>& players);
