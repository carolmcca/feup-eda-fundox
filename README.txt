...
- Improvements: 
	...
	* As stated before, if a player inserts 3 consecutive non valid words, they lose their turn. Besides, it is considered that the player passed their turn, to prevent
...
require the presence of some repetitive parts of code.